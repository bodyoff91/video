...
@Client.on_message(command(["update","تحديث", f"update@{BOT_USERNAME}"]) & ~filters.edited)
@sudo_users_only
async def update_repo(_, message: Message):
    ...
    if update_avail:
        ...
        return
    await msg.edit("bot is **up-to-date** with [main](https://github.com/islam-20055/video/tree/main)", disable_web_page_preview=True)
